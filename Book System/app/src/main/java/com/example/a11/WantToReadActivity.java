...
public class WantToReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Book> allBooksAlreadyRead = Utils.getInstance(this).getWantToReadBooks();
        adapter.setBooks(allBooksAlreadyRead); // or i can use directly Utils.getwanttoreadbooks directly without using get instance as it;s static s
